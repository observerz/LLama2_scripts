...
def main():
    ...
    src_ctx = ''
    tgt_ctx = ''
    prompt1 = 'Given the provided parallel sentence pairs, translate the following '
    prompt2 = ' sentence to '
                ...
                if cnt_line in test_en_list:# the current src sentence is En
                    ...
                    for k in range(0,i):
                        if tempid in test_en_list:
                            Src += src_lang + s_docs[k] + ' ' + tgt_lang + t_docs[k] + '\n'
                        if tempid in test_de_list:
                            Src += src_lang + t_docs[k] + ' ' + tgt_lang + s_docs[k] + '\n'
                        tempid += 1
                    Src += prompt1 + 'English' + prompt2 + 'German:\n'+'English Sentence: ' + tempSrc + '\nGerman Sentence: '
                if cnt_line in test_de_list:
                    src_lang = 'German: '
